        ...
        <div class="col-12">
            ...
            >
                <div class="d-flex align-items-center">
                    <div>
                        {{ trans('plugins/construction::categories.table_view_info') }}
                        <a
                            href="{{ route('construction.categories.index', ['as' => 'table']) }}"
                            class="text-decoration-underline"
                        >
                            {{ trans('plugins/construction::categories.manage_as_table') }}
                        </a>
                    </div>
                </div>
            </x-core::alert>
